...
<div class="content-container">
  <div id="pub-container">
    ...
    (
        <a id="publication-by-selected", onClick="publicationBySelected();">show selected</a> /
        <a id="publication-by-date", onClick="publicationByDate();">show all by date</a> /
        <a id="publication-by-topic", onClick="publicationByTopic();">show all by topic</a>
    )
    </h1>
